            ...
            <motion.div
                ...
                {filteredWorks.map((work, index) => (
                    <motion.div
                        ...
                        className='w-72 flex-col flex justify-center items-center m-8 p-4 rounded-lg bg-white text-black cursor-pointer transition-all duration-300 ease-in hover:shadow-md 3xl:w-96 lg:p-5 3xl:rounded-xl' key={`${work.title}-${index}`}>
                        <div className='flex items-center justify-center w-full h-56 3xl:h-80 relative'>
                            <img className='w-full h-full rounded-lg object-cover' src={work.imgUrl} alt={work.title} />
                        ...
                        <div className='p-2 w-full relative flex-col flex justify-center items-center'>
                            <h4 className='mt-4 leading-6 3xl:mt-12 text-base font-extrabold text-black text-left'>{work.title}</h4>
                            <p className='text-sm text-left text-gray-600 leading-6 3xl:text-3xl mt-2'>{work.description}</p>

                            <div className='absolute py-2 px-4 rounded-xl bg-white -top-8 flex justify-center items-center'>
                                <p className='text-sm text-left text-gray-500 leading-6 3xl:text-3xl'>{work.tags[0]}</p>
                            </div>
                        </div>
