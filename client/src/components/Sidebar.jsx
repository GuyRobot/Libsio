            ...
            <div className="overflow-hidden bg-gray-50 tabs-panel shadow-md border-r border-gray-100">
                <div className="py-5 space-y-6 sm:p-6">
                    <div className="mt-4 space-y-6">
                        {categories && categories.map((obj, idx) => (
                            <div className="tab-panel group" key={obj.category?.slug ?? "Uncategorized"}>
                                <Link to={obj.category ? `?category=${obj.category?.slug}` : ""}>
                ...
                border border-gray-100
              ">
                                            <span className="text-xs text-indigo-600">{obj.count}</span>
                                        </div>
                                    </div>
                                </Link>
                            </div>
