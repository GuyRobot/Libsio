      ...
      {({
        ...
        return (
          <form className="flex flex-col m-auto mt-8" onSubmit={handleSubmit}>
            ...
            {errors.title && (
              <div className="text-sm mt-1 text-red-800">{errors.title}</div>
            )}
            ...
            {errors.link && (
              <div className="text-sm mt-1 text-red-800">{errors.link}</div>
            )}
            ...
            <div className="mt-4">
              ...
              <div className="mt-1">
                <ReactTags
                  ...
                  tags={tags}
                  handleDelete={(tag) => {
                    handleDelete(tag, setFieldValue);
                  }}
                  handleAddition={(tag) => {
                    handleAddition(tag, setFieldValue);
                  }}
                  handleDrag={(tag, curPos, newPos) => {
                    handleDrag(tag, curPos, newPos, setFieldValue);
                  }}
            ...
            "
              ...
              {errors.image && (
                <div className="text-sm mt-1 text-red-800">{errors.image}</div>
              )}
            </div>
